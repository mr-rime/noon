            ...
            <div>
                <div className="flex items-center justify-between w-full  ">
                    <div className="text-[14px] ">
                        <span className="text-[20px] font-bold">Total</span> <span className="text-[#7e859b] ">(Inclusive of VAT)</span>
                    </div>
                ...
                <div className="mt-5">
                    <button className="text-white bg-[#3866df] hover:bg-[#3e72f7] transition-colors cursor-pointer w-full h-[48px] text-[14px] font-bold uppercase p-[16px] rounded-[4px]">Checkout</button>
                </div>
            </div>
        </div>
    )
