...
export function ProductPageRates({ theme = "desktop" }: { theme?: 'desktop' | 'mobile' }) {
	return (
		theme === "desktop" ? <div className="flex items-center space-x-2 mt-2">
		...
		</div> : <div className="flex items-center justify-center w-fit space-x-2  bg-[#f3f4f8] py-[4px] px-[6px] rounded-[6px]">
