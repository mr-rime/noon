	...
	return (
		<div className="flex flex-col items-start">
			<div>
				<button
					onClick={() => navigate({ to: "." })}
					className="text-[#3866df] underline text-[22px] text-start font-bold cursor-pointer"
				>
					noon
				</button>
			</div>
			...
			<div className="flex items-center space-x-[8px] w-full">
				<div className="bg-white rounded-[8px] w-1/2 relative border border-[#ebecf0] p-[16px]">
					<div className="flex items-center justify-between">
						<div className="font-bold text-[16px] text-start">Seller Rating</div>
					...
					<div>
						<span className="text-[#404553] font-bold text-[14px]">81%</span>{" "}
						<span className="text-[#9ba0b1] text-[14px]">Positive Ratings</span>
					</div>
				</div>
				<div className="bg-white rounded-[8px] w-1/2 relative border border-[#ebecf0] p-[16px]">
					<div className="flex items-center justify-between">
						<div className="font-bold text-[16px] text-start">Customers</div>
					</div>
					<div className="flex items-center space-x-1.5 mt-1">
			...
			<div className="flex items-center justify-start bg-white rounded-[8px] w-full mt-4 relative border border-[#ebecf0] p-[16px]">
				...
				<div className="w-1/2 ">
					<span className="text-[#9ba0b1] text-start text-[14px]">
			...
			<div className="flex flex-col items-start justify-center bg-white rounded-[8px] w-full mt-4 relative border border-[#ebecf0] p-[16px]">
				<div className="flex items-center w-full space-x-2">
					...
					<div className="w-full flex items-center space-x-1">
						...
						<div className="text-[#38AE04] font-bold text-[14px]">90%</div>
					</div>
				</div>
			...
			<div>
				...
				<div className="text-[14px] font-bold">December, 2020</div>
			</div>
		</div>
	);
}
