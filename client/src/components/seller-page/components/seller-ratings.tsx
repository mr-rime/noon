        ...
        <section className="p-[36px_36px_16px] bg-white flex-auto max-w-[50%]">
            ...
            <div className="mt-[17px]">
                ...
                <div className="text-[#9ba0b1] text-[14px]">
                    There are 169299 ratings and 79576 reviews for this seller
                </div>
                <Separator className="my-2" />
            </div>
            ...
            <div className="flex flex-col items-start">
                ...
                <SellerReview />
                <SellerReview />
                <Button className="bg-transparent text-[#3866df] font-bold text-[12px] border border-[#3866df] h-[32px] px-[16px] rounded-[4px] hover:bg-transparent hover:opacity-[.8] mt-5">View All Reviews</Button>
            </div>
        </section>
    )
}
