            ...
            <div className="z-[2]">
                ...
                <div className="flex items-center space-x-5">
                    ...
                    <p className="text-[12px] text-left line-clamp-3 max-w-[270px]">
                        COUGAR Roller Skate Shoe Cougar Model 509 For Adult Adjustable Roller
                        Skates with 4 Illuminating Pu Wheels, Outdoors and Indoors Roller
                        Blades for Boys Girls Beginners Color : Black Size : 42
                    </p>
                </div>
            </div>
