...
export function LogoutMenu() {
	...
	return (
		<section className="p-[8px] flex flex-col items-start gap-[4px] rounded-[12px] bg-white">
			<h3 className="text-[12px] uppercase font-bold text-[#6a6a6a] ml-3 mb-2">Others</h3>
			<ul className="w-full">
				<li className="w-full">
					<button
						onClick={handleLogout}
						className={cn(
							"flex items-center hover:bg-[#ff000014] rounded-[8px] transition-colors h-[48px] w-full p-[0_8px] space-x-[16px] cursor-pointer",
						)}
					>
