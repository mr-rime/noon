...
export function PersonalInformation({ user, loading }: { user: User | undefined; loading: boolean }) {
	...
	return (
		<section className="bg-white rounded-[20px] p-[32px] mt-7">
			<h2 className="text-[18px] font-bold">Personal Information</h2>

			<div className="mt-5 flex items-center space-x-6 flex-wrap">
				{loading ? (
					<Skeleton className="rounded-[12px] w-[300px] h-[58px] p-[8px_12px] mt-8" />
				) : (
					<Input
						id="firstName"
						name="firstName"
				...
				<Select
					...
					className="bg-white rounded-[12px] w-[300px] h-[58px] p-[8px_12px]"
				/>
