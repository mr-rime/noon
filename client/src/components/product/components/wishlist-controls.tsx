    ...
    <div className="mt-5 flex items-center justify-between gap-2 ">
      ...
      <Dropdown
        ...
        <button className="flex w-full cursor-pointer items-center gap-2 border-gray-200/80 border-b p-2 text-start transition-colors hover:bg-gray-300/10">
          ...
          Move to another wishlistt
        </button>
        <button className="flex w-full cursor-pointer items-center gap-2 border-gray-200/80 border-b p-2 text-start transition-colors hover:bg-gray-300/10">
          <Clipboard size={15} color="#3866DF" />
          Copy to another wishlistt
        </button>

        <button className="flex w-full cursor-pointer items-center gap-2 p-2 text-start text-[#FB2020] transition-colors hover:bg-gray-300/10">
