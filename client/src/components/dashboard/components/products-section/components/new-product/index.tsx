        ...
        <div className="px-10 py-20 w-full min-h-screen">
            ...
            <div className="w-full min-h-[calc(100vh-160px)] bg-white p-5 rounded-[8px]">
                ...
                <div className="mt-5 w-full flex items-start justify-end">
                    {
                        loading ? <Button className="bg-[#3866df] text-white w-full px-4 py-2 rounded-md md:w-[100px] flex items-center justify-center">
                            <Loader2 size={20} className="animate-spin" />
                        </Button> : <Button onClick={handleCreateNewProduct} className="bg-[#3866df] w-full md:w-[100px] text-white px-4 py-2 rounded-md">Publish</Button>
                    }
                </div>
            </div >
        </div >
