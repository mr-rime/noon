...
import { UPDATE_PRODUCT } from '@/features/product/api/product'
import { ProductImageManager, type ProductImageManagerRef } from '@/shared/components/product-image-manager'
import { useDebounce } from '@/shared/hooks/use-debounce'
import type { ProductType, ProductImage, ProductSpecification } from '@/shared/types'
