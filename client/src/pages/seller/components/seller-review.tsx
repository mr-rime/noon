  ...
  return (
    <div className="w-full break-words border-[#f3f4f8] border-b py-[24px]">
      <div className="mb-[8px] flex items-start gap-[4px_8px] ">
        <div className="flex h-[34px] w-[34px] items-center justify-center rounded-full bg-[#eff3fd] font-bold text-[#374151] text-[14px]">
          A
        </div>
        <div className="flex items-start justify-between space-x-[20px]">
          <div className="flex flex-col items-start">
            <div className="text-[14px]">Ahmed H.</div>
            <div className="text-[#374151] text-[12px]">Jun 17, 2025</div>
          </div>
      ...
      <div className="flex items-center space-x-1">
        ...
        <button className="cursor-pointer font-bold text-[#374151] text-[14px] hover:opacity-[.8]">Report</button>
      </div>
    </div>
  )
}
