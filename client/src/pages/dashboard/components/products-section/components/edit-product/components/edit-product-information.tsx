...
import { EditOptionSection } from './edit-option-section'
import { EditSpecSection } from './edit-spec-section'
...
export function EditProductInformation({ product }: { product: ProductType }) {
  ...
  return (
    <div className="h-[calc(100vh-160px)] min-h-full w-full space-y-4 overflow-auto rounded-xl border border-[#E4E4E7] p-5 md:w-1/2">
      <Input
      ...
      <div className="flex flex-col items-start justify-center gap-2">
        ...
        <textarea
          ...
          className="w-full rounded-[8px] border border-[#E2E5F1] px-3 pt-3 text-[16px] outline-none"
          rows={4}
        />
      </div>
      ...
      <EditOptionSection options={product.productOptions} />
      <Separator className="my-7" />
      <EditSpecSection specs={product.productSpecifications} />
    </div>
  )
}
